...
export const LogoAlt1 = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            className={cn('text-foreground h-6 w-full', className)}
            viewBox="0 0 797 220"
...
export const LogoIconAlt1 = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            className={cn('size-6', className)}
            viewBox="0 0 180 220"
...
export const LogoAlt2 = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            className={cn('text-foreground h-6 w-full', className)}
            viewBox="0 0 797 220"
...
export const LogoIconAlt2 = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            className={cn('size-6', className)}
            viewBox="0 0 180 220"
