...
const navItems = [
  ...
  { href: "/dashboard/executions", label: "Executions", icon: ExecutionsIcon },
  { href: "/dashboard/credentials", label: "Credentials", icon: CredentialsIcon },
];
        ...
        <SidebarMenu>
          {!isLoading && (
            <SidebarMenuItem>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={cn("size-4", !hasActiveSubscription && "text-amber-400")}>
