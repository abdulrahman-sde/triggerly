      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}
            ...
            Describe a workflow. Sprint builds it.
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}
            ...
            <span className="text-white font-medium">Sprint AI turns a plain-English description into a ready-to-run flow.</span> Say what you want to automate and let AI wire the nodes.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5 }} className="mt-16">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="border-t border-r border-b border-zinc-800/60 pt-12 pr-12 pb-16">
                ...
                <p className="text-zinc-500 text-base mb-8">Describe what you need in plain English. Sprint AI picks the right triggers, actions, and branches to build a working workflow.</p>
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <span className="text-zinc-500 text-sm">Generated by <span className="text-zinc-300">Sprint AI</span></span>
                  </div>
              ...
              <div className="border-t border-b border-zinc-800/60 pt-12 pl-12 pb-16">
                ...
                <p className="text-zinc-500 text-base mb-8">Connect any external service with webhooks, or use the Sprint API to trigger workflows from your own backend.</p>
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  ...
                  <div className="space-y-1 mb-6">
                    ...
                    <p className="pl-4"><span className="text-orange-400/70">&quot;endpoint&quot;</span><span className="text-zinc-500">: </span><span className="text-green-400/70">&quot;https://hooks.sprint.app/w/&quot;</span></p>
                  </div>
