      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">
            Trigger on a schedule, a webhook, or an event.
          </span>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            ...
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Browse past runs, filter by status or trigger, and drill into any
              execution to see per-node timing and output.
            </p>
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  >
                    <div
                      className={`w-2 h-2 rounded-full ${run.statusColor}`}
                    />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-zinc-200 font-medium">Retry policies</span>
            </div>
            <p className="text-zinc-500 text-sm leading-relaxed">
